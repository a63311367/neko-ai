use neko::embeddings::{Embedding, EmbeddingModel};
use neko::vector_store::{VectorStoreError, VectorStoreIndex};
use neko::OneOrMany;
...
/// use neko::Embed;
/// use serde::Deserialize;
/// use neko_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for neko.
///
/// This crate provides a SQLite-based vector store implementation that can be used with neko.
...
///     Embed,
/// };
/// use neko_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]
