//! EternalAI API client and neko integration
//!
//! # Example
//! ```
//! use neko::providers::eternalai;
//!
...
impl Client {
    ...
    /// # Example
    /// ```
    /// use neko::providers::eternalai::{Client, self};
    ///
    ...
    /// let eternalai = Client::new("your-open-ai-api-key");
    ///
    /// let embedding_model = eternalai.embedding_model("model-unknown-to-neko", 3072);
    /// ```
