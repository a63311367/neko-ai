//! neko is a Rust library for building LLM-powered applications that focuses on ergonomics and modularity.
//!
//! # Table of contents
...
//! neko provides a consistent API for working with LLMs and embeddings. Specifically,
...
//!
//! ## Agents
//! neko also provides high-level abstractions over LLMs in the form of the [Agent](crate::agent::Agent) type.
//!
...
//! neko provides a common interface for working with vector stores and indexes. Specifically, the library
...
//! # Integrations
//! ## Model Providers
//! neko natively supports the following completion and embedding model provider integrations:
//! - OpenAI
//! - Cohere
//! - Anthropic
//! - Perplexity
...
//!
//! ## Vector Stores
//! neko currently supports the following vector store integrations via companion crates:
//! - `neko-mongodb`: Vector store implementation for MongoDB
//! - `neko-lancedb`: Vector store implementation for LanceDB
//! - `neko-neo4j`: Vector store implementation for Neo4j
//! - `neko-qdrant`: Vector store implementation for Qdrant
//!
