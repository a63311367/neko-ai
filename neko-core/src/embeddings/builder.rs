...
///         "2. *flurbo* (noun): A fictional digital currency that onekoinated in the animated series Rick and Morty.".to_string()
        ...
        vec![
            WordDefinition {
                ...
                definitions: vec![
                    ...
                    "A fictional digital currency that onekoinated in the animated series Rick and Morty.".to_string()
                ]
            },
            WordDefinition {
                id: "doc1".to_string(),
