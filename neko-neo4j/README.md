...
You can also run `cargo add neko-neo4j neko-core` to add the most recent versions of the dependencies to your project.
...
- Add support for creating the vector index through neko.
