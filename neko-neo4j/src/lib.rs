//! A neko vector store for Neo4j.
//!
//! This crate is a companion crate to the [neko-core crate](https://github.com/neko-ai/neko-core).
//! It provides a vector store implementation that uses Neo4j as the underlying datastore.
//!
//! See the [README](https://github.com/0xPlaygrounds/neko/tree/main/neko-neo4j) for more information.
//!
//! ## Prerequisites
//!
//! ### GenAI Plugin
...
//!
//! ## Simple example:
//! More examples can be found in the [/examples](https://github.com/0xPlaygrounds/neko/tree/main/neko-neo4j/examples) folder.
//! ```
//! use neko_neo4j::{vector_index::*, Neo4jClient};
//! use neo4rs::ConfigBuilder;
//! use neko::{providers::openai::*, vector_store::VectorStoreIndex};
...
use neo4rs::*;
use neko::{embeddings::EmbeddingModel, vector_store::VectorStoreError};
use serde::Deserialize;
...
fn neo4j_to_neko_error(e: neo4rs::Error) -> VectorStoreError {
